#!/bin/bash
#SBATCH -J bwa_300s	# job name
#SBATCH -o bwa_300s_%j		# output and error file name (%j expands to jobID)
...
for i in $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_3*.fastq
do
