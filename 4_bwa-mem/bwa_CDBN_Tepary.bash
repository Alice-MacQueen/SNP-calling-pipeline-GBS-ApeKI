#!/bin/bash
#SBATCH -J bwa_Tep	# job name
#SBATCH -o bwa_Tep_%j		# output and error file name (%j expands to jobID)
...
for i in $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_Tepary*.fastq
do
