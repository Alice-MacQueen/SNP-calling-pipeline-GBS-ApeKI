#!/bin/bash
#SBATCH -J bwa_rrn2	# job name
#SBATCH -o bwa_rrn2_%j		# output and error file name (%j expands to jobID)
#SBATCH -n 1			# total number of mpi tasks requested
#SBATCH -p normal		# queue (partition) -- normal, development, largemem(x4), etc.
#SBATCH -t 6:00:00		# run time (hh:mm:ss) - 4 hours
...
for i in $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_155_*.fastq $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_051_*.fastq $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_052_*.fastq $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_063_*.fastq $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_069_*.fastq $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_267_*.fastq
do
