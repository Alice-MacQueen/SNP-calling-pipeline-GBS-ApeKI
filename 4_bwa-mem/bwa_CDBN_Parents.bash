#!/bin/bash
#SBATCH -J bwa_Pare	# job name
#SBATCH -o bwa_Pare_%j		# output and error file name (%j expands to jobID)
...
for i in $SCRATCH/sickle_trim_all/sickle_all3pr_CDBN_Parent*.fastq
do
